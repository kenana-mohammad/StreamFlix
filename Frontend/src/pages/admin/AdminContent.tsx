    ...
    <div className="min-h-screen pt-20 pb-12">
      <div className="px-4 sm:px-6 lg:px-12 max-w-6xl mx-auto">
        ...
        <div className="glass rounded-xl border border-ink-600 p-8 text-center">
          <p className="text-gray-400 mb-4">Content module is coming soon</p>
          <p className="text-gray-500 text-sm">This section will allow you to add, edit, and manage movies and series in the catalog.</p>
        </div>
      </div>
    </div>
  );
